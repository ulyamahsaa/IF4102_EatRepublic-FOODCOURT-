		...
		<div class="row">
			<div class="col-sm-6">
				<a href="<?php echo base_url('') ?>index.php/home">
					...
					<h3 class="warna">Registrasi <b><span class="warna1"> pembeli</span></b></h3>
					<h5>Silahkan mengisi form dengan lengkap</h5>
					<form action="<?php echo site_url('C_regispembeli/proses_regis')?>" method="POST" class="form-sigin">
						<div class="form-group" style="margin-left: 10.5%; font-family: Wacca Regular; margin-right: 10%">
					...
					<button class="btn btn-dark" style="margin-left: 35%;padding-left:10%;padding-right:10%; font-family: Wacca Regular">
						Submit
					</button> 
				</form>
			</div>
