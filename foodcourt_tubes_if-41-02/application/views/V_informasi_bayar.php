...
<body>
<nav class="navbar-light bg-light vertical-navigation">
  <ul class="navbar-nav">
    ...
    <li class="nav-item"> 
      <a class="nav-link" href="#" disabled><img src="<?php echo base_url('')?>assets/image/payment-method.png" alt="payment"></a>
    </li>
    <li class="nav-item" style="margin-top: 39rem;">
    	<a class="nav-link" href="#"><img src="<?php echo base_url('')?>assets/image/logo.png"></a>
    </li>
  </ul>
</nav>
...
<div class="page-content">
	<div class="container box-color">
		...
		<div class="col-xs-6">
			<h1 class="text-center" style="margin-right: 5rem; margin-top: 5rem;">Pembayaran anda Berhasil!</h1>
		</div>
		<div class="col-xs-6">
			<a href="<?php echo base_url('') ?>index.php/home"><h5 class="text-right" style="margin-right: 5rem; margin-top: 5rem;"><button class="btn btn-default" style="margin-bottom: 3rem;">OK</button></h5></a>
